...
camera       = videoinput('winvideo', 1, 'YUY2_320x240');% ustawic odpowiedni nr kamery oraz rozdzielczosc
...
nazwaObiektu = 'obiektC';           % nazwa obiektu (ustaw odpowiednio - bez polskich znakow!)
...
if typZbioru==0
    outputFolder = ['daneUczace/' nazwaObiektu];       % nazwa podkatalogu do zapisu danych
else
